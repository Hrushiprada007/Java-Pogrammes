...
class SavingsAccount extends BankAccount {
    private static final double MINIMUM_BALANCE = 1000; // Minimum balance required for savings account
...
class CurrentAccount extends BankAccount {
    private static final double OVERDRAFT_LIMIT = 5000; // Overdraft limit for current account
